            ...
            <form v-on:submit.prevent="editEmployee" id="newForm">
                ...
                <div v-if="departments.length">
                    ...
                    <div class="custom-control custom-checkbox mb-1" v-for="department in departments" :key="department.id">
                        <input type = "checkbox" class="custom-control-input" :id="department.id" :value="department.id"  @click="delete_error_message('department_id')" v-model="employee.department_id"/>
